-- Open sourced by Guvy https://discord.gg/pjuj99ure
...
if CoreGui:FindFirstChild("luni010_HubGui") then
CoreGui["luni010_HubGui"]:Destroy()
end


local screenGui = Instance.new("ScreenGui")
screenGui.Name = "luni010_HubGui"
...
ColorSequenceKeypoint.new(0.00, Color3.fromRGB(255, 255, 0)), -- Yellow here
ColorSequenceKeypoint.new(0.50, Color3.fromRGB(255, 255, 0)), -- Yellow here
ColorSequenceKeypoint.new(1.00, Color3.fromRGB(255, 255, 0)) -- Yellow here
})
...
borderStroke.Color = Color3.fromRGB(255, 255, 0)
...
title.Text = "luni010_Hub semi TP"
...
subtitle.Text = "made by luni010_"
...
local label = Instance.new("TextLabel") label.Size = UDim2.new(1, -40, 1, 0) label.BackgroundTransparency = 1 label.Text = text label.TextColor3 = Color3.fromRGB(255, 255, 0) label.TextSize = 8 label.Font = Enum.Font.GothamMedium label.TextXAlignment = Enum.TextXAlignment.Left label.Parent = container local btn = Instance.new("TextButton") btn.Size = UDim2.new(0, 35, 0, 18) btn.Position = UDim2.new(1, -35, 0.5, -9) btn.BackgroundColor3 = Color3.fromRGB(40, 40, 40) btn.Text = "" btn.Parent = container local btnCorner = Instance.new("UICorner", btn) btnCorner.CornerRadius = UDim.new(1, 0) local dot = Instance.new("Frame") dot.Size = UDim2.new(0, 14, 0, 14) dot.Position = UDim2.new(0, 2, 0.5, -7) dot.BackgroundColor3 = Color3.fromRGB(255, 255, 255) dot.Parent = btn local dotCorner = Instance.new("UICorner", dot) dotCorner.CornerRadius = UDim.new(1, 0) local active = false btn.MouseButton1Click:Connect(function() active = not active local goal = active and UDim2.new(1, -16, 0.5, -7) or UDim2.new(0, 2, 0.5, -7) local col = active and Color3.fromRGB(255, 50, 50) or Color3.fromRGB(40, 40, 40) TweenService:Create(dot, TweenInfo.new(0.15), {Position = goal}):Play() TweenService:Create(btn, TweenInfo.new(0.15), {BackgroundColor3 = col}):Play() callback(active) end)
...
spamButton.TextColor3 = Color3.fromRGB(255, 255, 0)
...
spamStroke.Color = Color3.fromRGB(255, 255, 0) -- Yellow border
...
discordText.Text = "discord.gg/pjuj99ure5"
...
antiStealButton.TextColor3 = Color3.fromRGB(255, 255, 0)
...
btnStroke.Color = Color3.fromRGB(255, 255, 0) -- Yellow border
...
autoTpRightButton.TextColor3 = Color3.fromRGB(255, 255, 0)
...
percentLabel.Text = "0%"
percentLabel.TextColor3 = Color3.fromRGB(255,255, 0)
...
dropdownButton.Text = "TP TO SPOT ▼" -- down arrow
...
dropStroke.Color = Color3.fromRGB(255, 255, 0) -- Yellow border
...
dropdownButton.Text = "TP TO SPOT ▼" -- down arrow
dropdownButton.Text = dropdownOpen and "TP TO SPOT ▲" or "TP TO SPOT ▼" -- toggle arrows
end)
