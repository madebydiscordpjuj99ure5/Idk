-- Open sourced by guvvy https://discord.gg/pjuj99ure5
...
if CoreGui:FindFirstChild("GuvvyHub") then
CoreGui["GuvvyHub"]:Destroy()
end

local screenGui = Instance.new("ScreenGui")
screenGui.Name = "GuvvyHub"
